...
function bbp_pro_is_license_valid() {
   //error_log('wp-content/plugins/buddyboss-platform-pro/includes/bb-pro-core-functions::bbp_pro_is_license_valid');
   return true;
	...
	error_log('wp-content/plugins/buddyboss-platform-pro/includes/bb-pro-core-functions::bbp_pro_is_license_valid::server_name.:'.$server_name.':.');
	...
	error_log('wp-content/plugins/buddyboss-platform-pro/includes/bb-pro-core-functions::bbp_pro_is_license_valid::is_multisite.:'.is_multisite().':.');
	if ( is_multisite() ) {
	...
	//{"key_id":"43126","order_id":"300038","subscription_id":"300039","activation_email":"jose.antonio.aveleyra@gmail.com","license_key":"dcf278bb-f384-4305-9008-5ae93f2ee21f","days_valid":395,"software_product_id":"BB_THEME_1S","software_version":"","activations_limit":"1","created":"2020-10-11 07:33:08","updated":"2022-10-25 01:23:04","status":true,"instance":"semanadeinnovacion.org","message":"Activated! 0 out of 1 activations remaining.","is_active":true,"product_keys":["BB_THEME","BB_PLATFORM_PRO"]}

	$license_exists = false;
	if ( ! empty( $saved_licenses ) ) {
		foreach ( $saved_licenses as $package_id => $license_details ) {
			error_log('wp-content/plugins/buddyboss-platform-pro/includes/bb-pro-core-functions::bbp_pro_is_license_valid::$license_details.:'.json_encode($license_details).':.');
