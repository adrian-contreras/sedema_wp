...
function bp_media_handle_sideload( $file_array, $post_data = array() ) {
	//error_log("bp-media-functions::bp_media_handle_sideload::".json_encode($file_array));
	...
	//error_log("bp-media-functions::bp_media_handle_sideload::::".json_encode($file));
	//return;
	...
	//error_log("bp-media-functions::bp_media_handle_sideload::::".json_encode($attachment));
	...
	//error_log("bp-media-functions::bp_media_handle_sideload::::".$id);
...
function bp_media_symlink_path() {
	//error_log('bp-media-functions::bp_media_symlink_path');
	$upload_dir = wp_upload_dir();
	$upload_dir = $upload_dir['basedir'];
	//error_log('bp-media-functions::bp_media_symlink_path::upload_dir::'.$upload_dir);
	$platform_previews_path = $upload_dir . '/bb-platform-previews';
	//error_log('bp-media-functions::bp_media_symlink_path::platform_previews_path::'.$platform_previews_path);
	...
	//$media_symlinks_path = $platform_previews_path . '/' . md5( 'bb_medias' );
	if ( ! is_dir( $media_symlinks_path ) ) {
		wp_mkdir_p( $media_symlinks_path );
		chmod( $media_symlinks_path, 0755 );
	}
	//error_log('bp-media-functions::bp_media_symlink_path::media_symlinks_path:.:'.$media_symlinks_path);
